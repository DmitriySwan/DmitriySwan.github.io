...

{
  var showTab = function showTab() {
    if (document.querySelector('.product-desc__thumb') && document.documentElement.clientWidth < 600) {
      var titleWrap = document.querySelector('.product-desc__title-wrap'),
          elem = document.querySelector('.product-desc__txt');
      titleWrap.addEventListener('click', function (e) {
        elem.classList.toggle('visible');
        titleWrap.classList.toggle('is-active');
      });
    }
  };
...

{
  var modalBtn = document.querySelectorAll('#modal-btn'),
      ...
      _closeBtn = document.querySelector('.modal__close-btn');

  window.addEventListener('resize', function (e) {
    scrollWidth = screen.width - document.documentElement.clientWidth;
  });
  modalBtn.forEach(function (openBtn) {
...
var thumbs2 = new Swiper('.slider-thumbs2', {
  spaceBetween: 10,
  slidesPerView: 4,
  // loop: true,
  breakpoints: {
    // when window width is >= 320px
    900: {
      slidesPerView: 7 // spaceBetween: 25
...
var sliderTop2 = new Swiper('.slider-top2', {
  spaceBetween: 10,
  loop: true,
  loopedSlides: 5,
  //looped slides should be the same
...
var sliderReviews = new Swiper('.reviews-swiper-container', {
  spaceBetween: 30,
  slidesPerView: 1,
  centeredSlides: true,
  loop: true,
